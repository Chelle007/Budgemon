...
export default function LoginView({ onLogin, onSignupSuccess }) {
    ...
    try {
      if (isSignUp) {
        ...
        if (data.user) {
          ...
          // If session exists, user can log in immediately (email confirmation disabled)
          // If no session, email confirmation is required
          if (data.session) {
            // Auto-login successful - proceed directly
            if (onSignupSuccess) {
